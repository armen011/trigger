...
const Footer = () => {
  return (
    <div className="w-full bg-white bg-opacity-10 px-4 md:px-20 2xl:px-32 pt-6 md:pt-12 rounded-t-[40px] md:rounded-t-[80px] lg:rounded-t-[100px] 2xl:rounded-t-[140px] z-50">
